...
public:
    ...
    QLabel *BBoxFileName;
    QPushButton *CropSaveButton_2;
    QPushButton *CropSaveButton_3;
    ...
    void setupUi(QMainWindow *gui)
    {
        ...
        ImageFileLabel = new QLabel(ImageBrowsingFrame);
        ImageFileLabel->setObjectName(QString::fromUtf8("ImageFileLabel"));
        sizePolicy2.setHeightForWidth(ImageFileLabel->sizePolicy().hasHeightForWidth());
        ImageFileLabel->setSizePolicy(sizePolicy2);
        ...
        CropSaveButton_2 = new QPushButton(MainContainer);
        CropSaveButton_2->setObjectName(QString::fromUtf8("CropSaveButton_2"));
        CropSaveButton_2->setGeometry(QRect(250, 580, 91, 25));
        CropSaveButton_3 = new QPushButton(MainContainer);
        CropSaveButton_3->setObjectName(QString::fromUtf8("CropSaveButton_3"));
        CropSaveButton_3->setGeometry(QRect(350, 580, 91, 25));
    ...
    void retranslateUi(QMainWindow *gui)
    {
        ...
        ImageFileLabel->setText(QCoreApplication::translate("gui", "DSC_...jpg", nullptr));
        ...
        CropSaveButton_2->setText(QCoreApplication::translate("gui", "Save YOLO", nullptr));
        CropSaveButton_3->setText(QCoreApplication::translate("gui", "Restore", nullptr));
    } // retranslateUi
